...
//    long first = Math.abs(first4);
    ...
    public AddStudentData(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon("C:\\Users\\j c\\IdeaProjects\\University Management System\\Picture\\4.jpg");
        ...
        String course[] = {"Mechanical" , "Software" , "Civil" , "Electrical"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String depart = (String)c1.getSelectedItem();


        if(ae.getSource() == b){
            try{
                sqlConnecter cc = new sqlConnecter();
                String q = "insert into student values('"+name+"','"+fName+"','"+age+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+matricPer+"','"+enterPer+"','"+houseNo+"','"+rollno+"','"+depart+"')";
    ...
    public static void main(String[ ] arg){
        new AddStudentData().f.setVisible(true);
    }
}
