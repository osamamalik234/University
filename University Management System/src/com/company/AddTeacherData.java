...
class AddTeacherData implements ActionListener{
    ...
    AddTeacherData(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon("C:\\Users\\j c\\IdeaProjects\\University Management System\\Picture\\5.jpg");
        ...
        String course[] = {"B.Tech","BBA","BCA","Bsc","Msc","MBA","MCA","BA","BCom","BS" , "B.E"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String matricPer = t8.getText();
        String enterPer = t9.getText();
        String houseNo= t10.getText();
        String education = (String)c1.getSelectedItem();
        String department = (String)c2.getSelectedItem();
        ...
        if(ae.getSource() == b){
            try{
                ...
                String q = "insert into teacher values('"+name+"','"+fName+"','"+age+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+matricPer+"','"+enterPer+"','"+houseNo+"','"+education+"','"+department+"','"+empId+"')";
    ...
    public static void main(String[] arg){
        new AddTeacherData().f.setVisible(true);
    }
}