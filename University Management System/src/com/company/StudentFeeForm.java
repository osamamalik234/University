...
public class StudentFeeForm extends JFrame implements ActionListener{
    ...
    public StudentFeeForm() {
        ...
        comboBox.setModel(new DefaultComboBoxModel(new String[] {"Software", "Mechanical", "CSE", "IT", "Civil", "Automobile", "Electronics", "Other" }));
        ...
        try{
            ...
            if(ae.getSource() == b1){
                try{
                    ...
                    String sql = "insert into fee(rollno, name, fName, course, department, semester, fee_paid) values(?, ?, ?, ?, ?, ?, ?)";
